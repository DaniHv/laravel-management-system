@extends('layouts.app', ['page' => 'Nuevo Recibo', 'pageSlug' => 'receipts', 'section' => 'inventory'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('receipts.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Información del Recibo</h6>
                            <div class="pl-lg-4">
