                        ...
                        <form method="post" action="{{ route('clients.update', $client) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label class="form-control-label" for="input-document_id">{{ __('Documento') }}</label>
                                        <input type="text" name="document_id" id="input-document_id" class="form-control form-control-alternative{{ $errors->has('document_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Document') }}" value="{{ old('document_id', $client->document_id) }}" required>
