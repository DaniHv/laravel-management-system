            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('transfer.store') }}" autocomplete="off">
                        @csrf
                        <h6 class="heading-small text-muted mb-4">Información de la Transferencia</h6>
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('sender_method_id') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-method">Método Remitente</label>
                            ...
                            <div class="form-group{{ $errors->has('sended_amount') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" step=".01" name="sended_amount" id="input-sended_amount" class="form-control form-control-alternative" placeholder="Monto Enviado" value="{{ old('sended_amount') }}" min="0" required>
                            ...
                            <div class="form-group{{ $errors->has('received_amount') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" step=".01" name="received_amount" id="input-received_amount" class="form-control form-control-alternative" placeholder="Monto Recibido" value="{{ old('received_amount') }}" min="0" required>
