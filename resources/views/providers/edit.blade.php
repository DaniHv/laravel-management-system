                        ...
                        <form method="post" action="{{ route('providers.update', $Provider) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Nombre" value="{{ old('name', $Provider->name) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="Teléfono" value="{{ old('emphoneail', $Provider->phone) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('paymentinfo') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="paymentinfo" id="input-paymentinfo" class="form-control form-control-alternative{{ $errors->has('paymentinfo') ? ' is-invalid' : '' }}" placeholder="Información de Pago" required>{{ old('paymentinfo', $Provider->paymentinfo) }}</textarea>
