@extends('layouts.app', ['class' => 'register-page', 'page' => 'Registro', 'contentClass' => 'register-page', 'section' => 'auth'])
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Nombre" value="{{ old('name') }}">
                        ...
                        <div class="form-check text-left {{ $errors->has('password') ? ' has-danger' : '' }}">
                            <label class="form-check-label">
                                ...
                                acepto la wea
                                <a href="#">terminos y su puta madre</a>.
                                @include('alerts.feedback', ['field' => 'agree_terms_and_conditions'])
                            </label>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-round btn-lg">Registrarme</button>
                    </div>
                </form>
            </div>
        </div>
