@extends('layouts.app', ['class' => 'login-page', 'page' => 'Login Page', 'contentClass' => 'login-page', 'section' => 'auth'])
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link">Crear cuenta</a>
                        </h6>
                    </div>
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link">Olvide Contraseña</a>
                        </h6>
                    </div>
                </div>
            </div>
