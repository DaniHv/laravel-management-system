...
class MethodController extends Controller
{
    ...
    public function store(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()->route('methods.index')->withStatus('Método de Pago creado satisfactoriamente.');
    }
    ...
    public function show(PaymentMethod $method)
    {
        ...
        return view('methods.show', [
            'method' => $method,
            'transactions' => Transaction::where('payment_method_id', $method->id)->orderBy('created_at', 'desc')->paginate(25),
            'balances' => $balances,
    ...
    public function update(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()->route('methods.index')->withStatus('Método de Pago actualizado satisfactoriamente.');
    }
    ...
    {
        $method->delete();
        return back()->withStatus('Método de Pago eliminado satisfactoriamente.');
    }
}
